...
This project provides a sample todo list application that demonstrates current Docker best practices. It includes a Compose file, Dockerfile, CI integration using GitHub Actions, and running tests.
